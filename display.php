...
<body>
	<div class="wrap">
		...
		<div style="width:100%;">
			...
			<p class="text-right text-info">  &copy; Copyrights Resesrved by Satish and Santhosh Co. PVT Ltd.</p>	
			</div>
			<div style="float:right;">
			<p class="text-right text-info">	Desinged By :Satish and Santhosh Co.</p>
			</div>
		</div>
		</footer>
	</div>
